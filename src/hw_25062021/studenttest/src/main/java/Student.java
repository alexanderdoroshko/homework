...
public class Student {
    ...
    private int age;
    private Sex sex;
    //Field for saving all students
    private static Map<Integer, Student> allStudent;
    //Counter to save student id
    ...
    public Student(String name, int age, Sex sex) {
        ...
        //Check if student is in map and if not
        //increase counterId, add it to id field and
        //put student into map
        if (!hasStudent()){
            countId++;
            this.id = countId;
    ...
    public static int getAverageAgeOfAllStudentsBySex(Sex sex){
