...
<div class="row">
    <div class="col-sm-10">
        <form action="${contextPath}/eshop?command=categorySearch" method="post">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Search" name="categoryType">
...
<div>
    <a href="${contextPath}/eshop?command=redirect-to-filter-search">
                ...
                <div class="card w-25 m-1" type="category">
                    <div class="card-body">
                        ...
                        <a href="${contextPath}/eshop?command=category-redirect&categoryType=${category.getName()}">
                            <img src="${contextPath}/images/${category.getImagePath()}" style="width:150px;height:120px"
