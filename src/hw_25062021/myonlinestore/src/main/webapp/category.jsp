...
<div class="row">
    <div class="col-sm-9">
        <form action="${contextPath}/eshop?command=productSearch" method="post" accept-charset="UTF-8">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Search" name="productType">
            ...
            <div class="row">
                <div class="col-sm-3" style="background-color:lavender;">
                    <a href="${contextPath}/eshop?command=product-redirect&product_id=${products.getId()}">
                        <img src="${contextPath}/images/${products.getImagePath()}" class="float-left"
