...
public class CommandFactory {
    ...
    static {
        ...
        COMMAND_LIST.put(CommandsEnum.REDIRECT_FILTER_SEARCH.getCommand(), new RedirectFilterSearchCommandImpl());
        COMMAND_LIST.put(CommandsEnum.SEARCH_CATEGORY.getCommand(), new SearchCategoryCommandImpl());
        COMMAND_LIST.put(CommandsEnum.SEARCH_PRODUCT.getCommand(), new SearchProductCommandImpl());
    }
